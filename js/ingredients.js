...
export const INGREDIENTS = {
  ...
  duck: { en: 'duck', 'zh-CN': '鸭肉', 'zh-TW': '鴨肉', aliases: ['鸭', '鴨', '鸭胸', '鸭腿', '鴨胸'] },
  greens: { en: 'greens', 'zh-CN': '时蔬', 'zh-TW': '時蔬', aliases: ['荠菜', '薺菜', '青菜', '蔬菜', '嫩菜', '菜心', '菜芯', '芥兰', '芥蘭', '小白菜', '上海青', 'choy sum', 'choy-sum', 'gai lan'] },
  oats: { en: 'oats', 'zh-CN': '燕麦', 'zh-TW': '燕麥', aliases: ['燕麦片', '麦片', 'oatmeal'] },
  banana: { en: 'banana', 'zh-CN': '香蕉', 'zh-TW': '香蕉', aliases: [] },
  orange: { en: 'orange', 'zh-CN': '橙子', 'zh-TW': '柳橙', aliases: ['橙', '橘子', '桔子'] },
  'rice wine': { en: 'rice wine', 'zh-CN': '料酒', 'zh-TW': '料酒', aliases: ['黄酒', '米酒', '绍兴酒', 'shaoxing', 'shaoxing wine'] },
  nuts: { en: 'nuts', 'zh-CN': '坚果', 'zh-TW': '堅果', aliases: ['核桃', '杏仁'] },
  cinnamon: { en: 'cinnamon', 'zh-CN': '肉桂', 'zh-TW': '肉桂', aliases: [] },
  seaweed: { en: 'seaweed', 'zh-CN': '海苔', 'zh-TW': '海苔', aliases: ['紫菜'] },
  mint: { en: 'mint', 'zh-CN': '薄荷', 'zh-TW': '薄荷', aliases: [] },
